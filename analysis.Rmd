...
tm_shape(wind_belt) +
  tm_polygons("state_name", title = "Whooping Crane Migration Corridor through the US") +
...
call_api_threat(us_birds$genus[1], us_birds$species2[1], df_all_threats)

df_threats <- map2_dfr(us_birds$genus[1:200], us_birds$species2[1:200], call_api_threat)
df_threats %>% 
